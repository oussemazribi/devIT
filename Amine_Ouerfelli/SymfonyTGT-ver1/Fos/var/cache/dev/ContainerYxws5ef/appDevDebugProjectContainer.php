...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once $this->targetDirs[3].'\\vendor\\endroid\\qr-code\\src\\Twig\\Extension\\QrCodeExtension.php';
            ...
            include_once $this->targetDirs[3].'\\vendor\\endroid\\qr-code\\src\\Writer\\AbstractBaconWriter.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Xw5RacKOg8', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0TtGsLCmPP', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'tunisiangottalent', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => [], 'defaultTableOptions' => []], $a, $c, []);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\FOSBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\CompetitionBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\PublicationBundle\\Entity'), 3 => ($this->targetDirs[3].'\\vendor\\mgilet\\notification-bundle\\Entity')]);
        ...
        $a->setEntityNamespaces(['FOSBundle' => 'FOSBundle\\Entity', 'CompetitionBundle' => 'CompetitionBundle\\Entity', 'PublicationBundle' => 'PublicationBundle\\Entity', 'MgiletNotificationBundle' => 'Mgilet\\NotificationBundle\\Entity']);
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_5c06ee5ae2749e0f0b51982de9cc51087bef1e3ad7bc552497862ccf25b9bfad');
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lMIjl8dmGv', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9PTtUgrpLv', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7V2Vjy3A-S', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['endroid.qrcode.factory'] = new \Endroid\QrCode\Factory\QrCodeFactory(['encoding' => 'UTF-8'], ${($_ = isset($this->services['endroid.qrcode.writer_registry']) ? $this->services['endroid.qrcode.writer_registry'] : $this->getEndroid_Qrcode_WriterRegistryService()) && false ?: '_'});
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\CompetitionBundle/Resources/views'), '!Competition');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\endroid\\qr-code\\src\\Bundle\\QrCodeBundle/Resources/views'), 'EndroidQrCode');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\endroid\\qr-code\\src\\Bundle\\QrCodeBundle/Resources/views'), '!EndroidQrCode');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'EndroidQrCodeBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\vendor\\endroid\\qr-code\\src\\Bundle\\QrCodeBundle'),
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'database_port' => NULL,
            'database_name' => 'tunisiangottalent',
            'database_user' => 'root',
            ...
            'buttons.facebook' => [
                'url' => 'www.facebook.com/migaloo.winner1/',
                'locale' => 'fr_FR',
                'send' => false,
                'width' => 300,
                'showFaces' => false,
