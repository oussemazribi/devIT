...
//                u.setMotDePasse(rs.getString("MotDePasse"));
 ...
 public String findByIdname(int idUser) throws SQLException {
         ...
         public String findByIlastname(int idUser) throws SQLException {
            String req = "select Prenom from user where idUser = ?";
            String var="";
            try {
                PreparedStatement ps = con.prepareStatement(req);
                ps.setInt(1, idUser);
          ...
          public String findbyImage(int idUser) throws SQLException {
            String req = "select ImgUser from user where idUser = ?";
            String var="";
            try {
                PreparedStatement ps = con.prepareStatement(req);
                ps.setInt(1, idUser);
