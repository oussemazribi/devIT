...
public class ServiceMessage implements IService<Message> {
    ...
    public void ajouter(Message t) throws SQLException {
        ...
        String requeteInsert = "INSERT INTO `message`  (`idMessage`,`id_Sender`, `id_Receiver`, `Contenu`, `Etat`, `Date_Message`, `id_Conversation`) VALUES (NULL, '" + t.getId_Sender() + "', '" + t.getId_Receiver() + "', '" + t.getContenu() + "', '" + t.getEtat() + "', NOW() ,'" + t.getId_Conversation() + "');";
 ...
 /* public void ajouter1(Message p) throws SQLException {
    ...
    public boolean delete(int id_Message) throws SQLException {
        PreparedStatement pre = con.prepareStatement("DELETE FROM `tunisiangottalent`.`message` where idMessage=?");
    ...
    public boolean transfer(int id_Message, int id_Conversation1) throws SQLException {
        ...
        String sql = "UPDATE message SET Date_Message=?, id_Conversation=? WHERE idMessage=?";
    ...
    public boolean SeenMessage(int id_Message) throws SQLException {
        ...
        String sql = "UPDATE message SET etat=? WHERE idMessage=?";
