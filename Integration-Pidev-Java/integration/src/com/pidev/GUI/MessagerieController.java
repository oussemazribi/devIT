...
public class MessagerieController implements Initializable {
    ...
    User userme = new User(Userconnected.getIdUser());
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            String aloo = su.findByIdname(Userconnected.getIdUser());
              String friendlastname = su.findByIlastname(Userconnected.getIdUser());
            UserName.setText(aloo+" "+friendlastname);
...
// calcul total unread messages !!! ( think about refresh after reply )
            ...
            Label UnreadConversations = new Label("Your private Conversation with " + alo);
            ...
            send_but.setStyle("-fx-background-color:#C44569; -fx-text-fill: #000000; -fx-font-size: 15; styleClass=\"txt-fld\"");

            InboxVB.setStyle("-fx-background-color: white;");
            ...
            reply.setStyle("-fx-background-color:  #C44569; -fx-text-fill: #000000; -fx-font-size: 15; styleClass=\"txt-fld\"");

            reply.setOnAction((event) -> {

                ServiceMessage ser = new ServiceMessage();
                Message mbs = new Message(Userconnected.getIdUser(), idfriend, rana.getText(), idconversation);
    ...
    public VBox readmessages(Message m) throws SQLException {
        ...
        if (m.getId_Sender() == idfriend) {
            String alo = su.findByIdname(idfriend);
            Image im1 = new Image("file:///C:/xampp/htdocs/projetZink/devIT/rana_chaabane/ServiceConnexion/src/Fxml/images/01.jpg");
            //Image im = new Image();
            String im = su.findbyImage(idfriend);
            File file = new File("C:/xampp/htdocs/Image_Pi/" + im);
