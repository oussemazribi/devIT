...
import com.esprit.Service.filetourl;
...
public class MessagerieController implements Initializable {
    ...
    int idfriend = userfriend.getIdUser();
   ...
   // int a = Integer.parseInt(getDetails());
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
//  System.err.println(Integer.parseInt(getDetails()));
            List<Message> MapM = sc.messageenvoyees(userme); // id user seesion
...
// calcul total unread messages !!! ( think about refresh after reply )
            ...
            reply.setOnAction((event) -> {
                ...
                Message mbs = new Message(idme, idfriend, rana.getText(), 34);
    ...
    public VBox readmessages(Message m) throws SQLException {
        ...
        if (m.getId_Sender() == idfriend) {
            ...
            messageBody.setStyle(" alignment=\"TOP_LEFT\"; -fx-text-fill: #000000; -fx-font-size: 15; styleClass=\"txt-fld\"");
